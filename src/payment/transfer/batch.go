...
import (
	...
	"github.com/stuartjing/PowerWeChat/v3/src/payment/transfer/request"
	"github.com/stuartjing/PowerWeChat/v3/src/payment/transfer/response"
	"net/http"
)
...
func (comp *BatchClient) QueryBatchDetail(ctx context.Context, batchID string, detailID string) (*response.ResponseQueryBatchDetail, error) {
