...
import (
	...
	response2 "github.com/stuartjing/PowerWeChat/v3/src/openPlatform/response"
	openplatform "github.com/stuartjing/PowerWeChat/v3/src/openPlatform/server/callbacks"
	"github.com/stuartjing/PowerWeChat/v3/src/openPlatform/server/handlers"
	"io"
	"io/ioutil"
	"net/http"
)
