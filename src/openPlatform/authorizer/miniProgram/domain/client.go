...
import (
	...
	"github.com/stuartjing/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/request"
	"github.com/stuartjing/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/response"
)
