...
import (
	...
	"github.com/stuartjing/PowerWeChat/v3/src/officialAccount/broadcasting/request"
	"github.com/stuartjing/PowerWeChat/v3/src/officialAccount/broadcasting/response"
)
