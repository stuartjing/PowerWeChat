...
import (
	...
	"github.com/stuartjing/PowerWeChat/v3/src/miniProgram/updatableMessage/request"
	"github.com/stuartjing/PowerWeChat/v3/src/miniProgram/updatableMessage/response"
)
